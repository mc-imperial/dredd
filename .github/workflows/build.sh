...
"Darwin"*)
  ...
  # The MacOS CI bots complain about the code that Dredd generates for
  # this test, but there appears to be nothing wrong with it, and it
  # is compiled successfully under Linux and Windows.
  # Tracked by https://github.com/mc-imperial/dredd/issues/275 and
  # should be re-enabled for MacOS once the issue is resolved.
  rm -rf test/execute/constant_sized_array
