 ...
 *
 * Uses n terms of the series expansion for sin to approximate the value of
 * sin(x).
 *
 ...
 *
 * Uses n terms of the series expansion for cos to approximate the value of
 * cos(x).
 *
 ...
 *
 * Uses n terms of the series expansion of sin and cos to approximate the value
 * of tan(x).
 *
 * @param x The value to apply cos to.
 * @param n The number of terms of the series expansion to generate.
 * @return the value of cos at x.
 * */
double TanN(const double &x, const int &n) { return SinN(x, n) / CosN(x, n); }

/**
 * Approximate the value of sec(x)
 *
 * Uses n terms of the series expansion of cos to approximate the value of
 * sec(x).
 *
 ...
 * */
double SecN(const double &x, const int &n) { return 1 / CosN(x, n); }

/**
 * Approximate the value of cosec(x)
 *
 * Uses n terms of the series expansion of sin to approximate the value of
 * cosec(x).
 *
 ...
 * */
double CosecN(const double &x, const int &n) { return 1 / SinN(x, n); }
 ...
 * */
double CotN(const double &x, const int &n) { return 1 / TanN(x, n); }
