...
do
  ...
  ${DREDD_INSTALLED_EXECUTABLE} ${DREDD_EXTRA_ARGS} --mutation-info-file temp.p --mutation-info-json temp.json "${copy_of_f}" --

  # Check that the JSON generated by Dredd is valid
  check_mutation_info_output.py temp.json temp.p
