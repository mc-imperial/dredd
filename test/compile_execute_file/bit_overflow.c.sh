...
DREDD_ENABLED_MUTATION=32 ${SCRIPTPATH}/bit_overflow.o > ${SCRIPTPATH}/bit_overflow.c.actual

# Compare actual output with expected output
if diff ${SCRIPTPATH}/bit_overflow.c.expected ${SCRIPTPATH}/bit_overflow.c.actual; then
    echo "Test Passed"
else
    echo "Test Failed"
fi
...
rm ${SCRIPTPATH}/bit_overflow.c.actual
